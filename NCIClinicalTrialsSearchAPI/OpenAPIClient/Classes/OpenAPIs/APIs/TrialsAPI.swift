...
open class TrialsAPI {
     ...
     */
    open class func getTrialByIdWithRequestBuilder(id: String) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    open class func searchTrialsByPost(body: AnyCodable, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func searchTrialsByPostWithRequestBuilder(body: AnyCodable) -> RequestBuilder<Void> {
        let localVariablePath = "/trials"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
